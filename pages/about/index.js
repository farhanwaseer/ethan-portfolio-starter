...
//         animate="show"
//         exit="hidden"
//         className="hidden xl:flex  absolute bottom- -left-[370px] "
//       >
//         <Avatar />
//       </motion.div>
...
//             collabrated on digital products fro business and consumer use.
//           </motion.p>
//           {/* counters  */}
//           <motion.div
...
//                   className={`relative cursor-pointer capitalize xl:text-lg text-white hover:text-accent transition-colors duration-300`}
//                 >
//                   {item.title}
//                   <span
...
//           </div>
//           <div
//             className="mx-9 py-2 xl:py-6 flex flex-col gap-y-2 xl:gap-y-4 items-center 
//           xl:items-start"
//           >
